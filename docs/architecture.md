...
The pipeline read is bounded and runs only at the escalation threshold, and a task with no delivery mode in its record drives no pipeline and skips it entirely.
