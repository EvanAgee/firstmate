...
| `fm-chrome-devtools-mcp.js` | Version-aware pinned chrome-devtools-mcp launcher for chrome-devtools-axi         |
...
| `fm-ci-watch.sh`         | Arm a one-shot GraphQL watch on one GitHub Actions run, optionally dispatching `ci.yml` first |
