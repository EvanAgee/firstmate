...
After this skill establishes harness and model/provider facts, load `quota-array-dispatch` before selecting from a matched rule or default with more than one member.
