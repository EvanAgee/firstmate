...
This skill is the sole owner of the completion-follow-up procedure below; AGENTS.md §8 declares the load trigger for Relay-linked milestone or terminal wakes, and AGENTS.md §14 reinforces the terminal final-follow-up step before teardown.
