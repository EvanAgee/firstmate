...
**Rig**:
A named ladder of harness models a class of tasks climbs when dispatching or retrying. A single step is a **rung**; a rung can be enabled or disabled, and a ladder can never have every rung off.
