...
It runs for every PR opening and body edit, then reads the current body with a short retry so a multi-write no-mistakes update cannot leave an earlier event permanently failed.
