...
Report only true captain-relevant outcomes or a declared external wait by appending one line:
   `echo "{state}: {one short line}" >> '/tmp/fm-worker-skills-validation.9Fpzgq/fm-spawn-dispatch-profile.bEEnd7/generated-secondmate/state/evidence-secondmate.status'`
