...
# its supervision verdict. Under Claude's successor-first coordinator, a live
# watcher keeps the beacon fresh across the handling turn and stays silent.
# Under Cursor's between-turns park, a normal fire leaves a recent beacon well
# inside grace and stays silent mid-turn. Under
