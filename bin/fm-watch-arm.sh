...
# reads this script's readiness line to keep a verified successor alive. Run it
# as its own standalone background task, never bundled onto the tail of another
# command.
