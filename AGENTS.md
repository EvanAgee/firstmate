...
state/               runtime records and signals; gitignored
  ...
  lavish-decisions/  private per-source bindings from a decision-carrying Lavish source id to the captain-hold origin its captured answers close at capture time; written by bin/fm-procevent-lavish.sh arm --decisions-origin, removed by retire (section 13; docs/decision-hold-lifecycle.md)
