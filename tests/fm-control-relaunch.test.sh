...
test_spawn_relaunch_refuses_a_live_agent() {
  ...
  assert_contains "$out" "an agent-free endpoint" "the refusal should demand an agent-free endpoint"
  assert_contains "$out" "or a gone endpoint it can recreate" "the refusal should name gone-endpoint recreation"
